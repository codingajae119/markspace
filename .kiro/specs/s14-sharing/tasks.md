...
- [ ] 2.1 (P) 공유 링크 발급·재발급·토글 유스케이스 구현
  ...
  - _Depends: 1.2_
- [ ] 2.2 (P) 공개 읽기 전용 렌더 유스케이스 구현 (동적 하위·안전 렌더·참조 재작성·실시간 게이트)
  ...
  - _Depends: 1.2_
- [ ] 2.3 링크 경유 첨부 서빙 유스케이스 구현 (유효성·서브트리·격리·s12 위임)
...
- [ ] 3.2 (P) 무효화 스윕 스케줄러 어댑터·엔트리포인트 구현
